                ...
                :
                    <Card overflowX={{ sm: "scroll", xl: "hidden" }}>
                           ...
                           
                            {
                                ...
                                <SimpleGrid columns={{ sm: 1, lg: 2 }} spacing={5} w="100%">
                                  
                                     
                                                <Box p='4' bg={bgColor} color="black" align="center" borderRadius="10px" >
                                                    Durasi Slide
                                                    <Center>
                                                        <Input   w="14" borderRadius="none" border="none" borderBottom="1px solid #c1c1c1" onChange={changeDurasi} value={durasi}  />
                                                    </Center>
                                                    Detik
                                                </Box>
                                                ...
                                                Jeda Waktu Syuruq
                                                    <Center>
                                                        <Input  w="14"   borderRadius="none" border="none" borderBottom="1px solid #c1c1c1"  onChange={changeSyuruq} value={syuruq}  />
                                                    </Center>
                                                    Menit
                                                </Box>
                                                ...
                                                <Box p='4' bg={bgColor} color="black" align="center" borderRadius="10px">
                                                    Jeda Waktu tahrim
                                                    <Center>
                                                         <Input  w="14"   borderRadius="none" border="none" borderBottom="1px solid #c1c1c1"  onChange={changeTahrim} value={tahrim}  />
                                                    </Center>
                                                    Menit
                                               </Box>
                                                ...
                                                <Box p='4' bg={bgColor} color="black" align="center" borderRadius="10px">
                                                    Jeda waktu iqamah
                                                    <Center>
                                                        <Input   w="14"   borderRadius="none" border="none" borderBottom="1px solid #c1c1c1"  onChange={changeIqamah} value={iqamah}  />
                                                    </Center>
                                                    Menit
                                                </Box>

                                                <Box p='4' bg={bgColor} color="black" align="center" borderRadius="10px">
                                                    Aktifkan Display Qurban
                                                    <Center>
                                                        <Select w="30"  value={qurbanDisplay} onChange={changeDisplayQurban}  borderRadius="none" border="none" borderBottom="1px solid #c1c1c1">
                                                                <option value='1' align="center">Aktif</option>
                                                                <option value='0' align="center"> Tidak Aktif</option>
                                                        </Select>
