...
function TambahGambarTeks() {
    ...
    const submitSimpan = async (event) => {
        ...
        formData.append("konten_image", fileGambar);
        formData.append("display_id", ID);
        formData.append("konten_type", "3");
        formData.append("konten_text", inputTeks);
        ...
        await axios({
            ...
            console.log("Masuk",res);
            alert("Berhasil Menambahkan Konten Gambar & Teks")
            history.goBack();
                                                        ...
                                                        <GridItem colSpan={3}>
                                                            ...
                                                            </Button>
                                                            {
                                                             ...
                                                             <FormLabel color="red" fontSize="10pt" mt="3">
                                                                    (<i>*Gambar yang diupload harus memiliki ratio 16:9</i>)
                                                                </FormLabel>
                                                        </GridItem>
                                                    </Grid>
...
export default TambahGambarTeks;
