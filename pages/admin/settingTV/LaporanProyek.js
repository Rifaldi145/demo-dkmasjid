...
function LaporanProyek() {
    ...
    const submitSimpan = async (event) => {
        ...
        var postData = {
            ...
            jadwal_start:tgl_awal,
            jadwal_end:tgl_akhir,
            material:material,
            pekerjaan:pekerja,
            total_dikeluarkan:pengeluaran,
        ...
        await axios({
            ...
            console.log("Masuk",res);
            alert("Berhasil Menambahkan Laporan Proyek");
            history.goBack();
    ...
    const onChangeNamaProyek = (event) => {
    ...
    const changeMaterial = (event) => {
        setMaterial(addCommas(removeNonNumeric(event.target.value)));
    };
    ...
    const changePekerja = (event) => {
        setPekerja(addCommas(removeNonNumeric(event.target.value)));
    };

    const changeDikeluarkan = (event) => {
                                                ...
                                                <Grid templateColumns={{ sm: '1fr', lg: 'repeat(3, 1fr)'}} gap={4} mb="16px">
                                                    ...
                                                    <Grid templateColumns={{ sm: '1fr', lg: 'repeat(1, 1fr)'}} gap={4} mb="16px">
                                                        <GridItem rowSpan={1} colSpan={1}>
                                                            ...
                                                            <Input type="text"      onChange={onChangeNamaProyek}  placeholder='Masukan Nama Proyek...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
                                                    ...
                                                    <Grid templateColumns={{ sm: '1fr', lg: 'repeat(1, 1fr)'}} gap={4} >
                                                    ...
                                                    <Grid templateColumns={{ sm: '1fr', lg: 'repeat(4, 1fr)'}} gap={4} mb="16px" mt="-12px">
                                                        <GridItem rowSpan={1} colSpan={2}>
                                                            <FormLabel ms="4px" color={nameColor} fontSize="sm" fontWeight="bold" pt="12px">
                                                                Meterial
                                                            </FormLabel>
                                                            <Input type="text"   onChange={changeMaterial}  placeholder='Masukan Material disini...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
                                                        ...
                                                        <GridItem colSpan={2}>
                                                            ...
                                                            <Input type="text"   onChange={changePekerja}  placeholder='Masukan pekerjaan/jasa disini...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
                                                    ...
                                                    <Grid templateColumns={{ sm: '1fr', lg: 'repeat(4, 1fr)'}} gap={4} mb="16px" mt="-12px">
                                                        <GridItem rowSpan={1} colSpan={2}>
                                                            ...
                                                            <Input type="text"   onChange={changeDikeluarkan}    placeholder='Masukan Total Dikeluarkan disini...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
