...
function JadwalKegiatan() {
    ...
    const submitSimpan = async (event) => {
        ...
        var postData = {
            display_id : ID,
            konten_type: '8',
            display_jadwal_kegiatan_id:JenisKegiatan,
            start:tgl_awal,
            end:tgl_akhir,
            acara:acara,
            narasumber:narasumber,
            waktu:waktu,
            deskripsi_waktu:deskripsi,
            tema:tema,
            nnotifikasi_hp:'1',
            tv:'1',
            terus_menerus:'1',
        ...
        await axios({
            ...
            console.log("Masuk",res);
            alert("Berhasil Menambahkan Jadwal Kegiatan");
            history.goBack();
            ...
            setLoading(false);
            console.log("AXIOS ERROR: ", err);
            alert("Anda Tidak Berhasil");
            if (err.response) {
                alert("Anda Tidak Berhasil 2");
                console.log("err.response", err.response.status);
                if(err.response.status == 401) {
                    alert("Anda Tidak Berhasil 3");
    ...
    const changeAcara = (event) => {
        setAcara(event.target.value);
    };

  

    const changeWaktu = (event) => {
        setWaktu(event.target.value);
    };

    const changeNarasumber = (event) => {
        setNarasumber(event.target.value);
    };

    const changeDeskripsi = (event) => {
                                        ...
                                        <Flex justify="space-between" w="100%">
                                            <Flex direction="column" w="100%">
                                                ...
                                                <Grid templateColumns={{ sm: '1fr', lg: 'repeat(3, 1fr)'}} gap={4} mb="16px">
                                                    ...
                                                    <br></br>
                                                    <Grid templateColumns={{ sm: '1fr', lg: 'repeat(1, 1fr)'}} gap={4} mb="16px">
                                                        <GridItem rowSpan={1} colSpan={1}>
                                                            <FormLabel ms="4px" color={nameColor} fontSize="sm" fontWeight="bold" pt="12px">
                                                                Jenis Kegiatan
                                                            </FormLabel>
                                                            <Select placeholder='Pilih Jenis Kegiatan' onChange={onChangeJenis}>
                                                                <option value='1'>Kajian Rutin</option>
                                                                <option value='2'>Diskusi/Usrah</option>
                                                                <option value='3'>Perayaan</option>
                                                                <option value='4'>Belajar Mengaji</option>
                                                             </Select>
                                                    ...
                                                    <Grid templateColumns={{ sm: '1fr', lg: 'repeat(4, 1fr)'}} gap={4} mb="16px" mt="10px">
                                                        <GridItem rowSpan={1} colSpan={2}>
                                                            <FormLabel ms="4px" color={nameColor} fontSize="sm" fontWeight="bold" pt="12px">
                                                                Acara
                                                            </FormLabel>
                                                            <Input type="text"   onChange={changeAcara}  placeholder='Masukan Acara disini...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
                                                        ...
                                                        <GridItem colSpan={2}>
                                                            ...
                                                            <Input type="text"   onChange={changeNarasumber}  placeholder='Masukan Narasumber disini...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
                                                    ...
                                                    <Grid templateColumns={{ sm: '1fr', lg: 'repeat(3, 1fr)'}} gap={4} mb="16px" mt="-12px">
                                                        <GridItem rowSpan={1} colSpan={1}>
                                                             
                                                             <FormLabel ms="4px" color={nameColor} fontSize="sm" fontWeight="bold" pt="12px">
                                                                Waktu
                                                            </FormLabel>
                                                            <Input type="text"   onChange={changeWaktu}  placeholder='Masukan Waktu disini...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
                                                        ...
                                                        <FormLabel ms="4px" color={nameColor} fontSize="sm" fontWeight="bold" pt="12px">
                                                            ...
                                                            <Input type="text"   onChange={changeDeskripsi}  placeholder='Masukan Deskripsi Singkat...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
                                                        ...
                                                        <FormLabel ms="4px" color={nameColor} fontSize="sm" fontWeight="bold" pt="12px">
                                                            ...
                                                            <Input type="text"   onChange={changeTema}  placeholder='Masukan Tema disini...'  bgColor="white" id="statusTayang" borderRadius="8px" color={nameColor} fontSize="sm"/>
