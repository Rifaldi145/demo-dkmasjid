...
export default function TambahWebview() {
    ...
    async function loadData() {
        ...
        await axios({
            method: 'GET',
            url: `${process.env.NEXT_PUBLIC_API_BACKEND}/api/baitiV1/webview/add`,
            headers: {
    ...
    const submitSimpan = async (event) => {
        ...
        if(url == null || url == '') {
            ...
            await axios({
                method: 'POST',
                url: `${process.env.NEXT_PUBLIC_API_BACKEND}/api/baitiV1/webview/simpan-konten`,
                headers: {
                    "Content-Type": `application/json`,
                    "Accept": `application/json`,
                    "Authorization": `Bearer ${token}`
